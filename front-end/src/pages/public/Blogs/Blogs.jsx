...
function BlogsGrid() {
  const { posts } = blogsContent;
  const SearchIcon = posts.search.icon;
    ...
    <section className={styles.posts}>
      <div className={styles.container}>
        ...
        <div className={styles.loadMore}>
          <Button>{posts.loadMoreButton}</Button>
        </div>
      </div>
    </section>
  );
...
function BlogsNewsletter() {
  const { newsletter } = blogsContent;
