    ...
    <group ref={group}>
      <Float speed={1.5} rotationIntensity={1} floatIntensity={2}>
        <mesh position={[2, 1, 0]}>
          ...
          <MeshDistortMaterial color="#7C3AED" distort={0.2} speed={2} roughness={0} metalness={0.8} />
        </mesh>
      </Float>
      ...
      <Float speed={2} rotationIntensity={1.5} floatIntensity={1.5}>
        <mesh position={[-2, -1, 1]}>
          ...
          <MeshDistortMaterial color="#06B6D4" distort={0.1} speed={1.5} roughness={0.1} metalness={0.9} />
        </mesh>
      </Float>
      ...
      <Float speed={1.2} rotationIntensity={2} floatIntensity={2.5}>
        <mesh position={[0, -2, -2]}>
          ...
          <MeshDistortMaterial color="#2563EB" distort={0.3} speed={2} roughness={0} metalness={1} />
        </mesh>
      </Float>
    </group>
  );
